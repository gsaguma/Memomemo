    ...
    return `
        <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div id="metaFileInfo" class="hidden flex items-center justify-between bg-[#F0F9FF] p-3 rounded-lg border border-[#93C5FD] shadow-sm text-sm flex-wrap gap-2">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button" id="changeMetaFileBtn" class="text-xs font-semibold text-[#3B82F6] hover:underline focus:outline-none min-h-[44px] md:min-h-0 px-2">Cambiar archivo</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="metadataCard" class="hidden bg-white rounded-lg p-4 shadow-md border border-[#93C5FD]">
                ...
                <button id="exportMetadataBtn" class="mt-2 w-full bg-primary hover:bg-opacity-90 text-white font-medium py-3 px-4 rounded shadow transition text-sm flex items-center justify-center gap-2">
